        ...
        {!hasUsedAppBefore ? (
          <>
            ...
            <div className="mx-auto mt-4 max-w-sm">
              <button
                onClick={openDialog}
                className="flex w-full cursor-pointer items-center justify-center rounded-full bg-primary px-6 py-2 text-sm font-semibold text-white shadow-sm hover:opacity-90"
              >
                Import from JSON
              </button>
            </div>
